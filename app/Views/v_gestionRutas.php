                ...
                <div class="contCampos" style="padding: 5px;">
                    ...
                    <?= form_open(current_url(), ['method' => 'post']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <?= form_label('Precio máximo:', 'precio_max', ['style' => 'color:white;']) ?>
                                <?= form_input([
                                    'type' => 'number',
                                    'name' => 'precio_max',
                                    'id' => 'precio_max',
                                    'value' => set_value('precio_max'),
                                    'step' => '1',
                                    'min' => $precioMinimo,
                                    'max' => $precioMaximo,
                                    'class' => 'form-control'
